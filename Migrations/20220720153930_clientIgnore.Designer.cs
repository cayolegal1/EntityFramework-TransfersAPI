...
namespace EntityFrame.Migrations
{
    ...
    [Migration("20220720153930_clientIgnore")]
    partial class clientIgnore
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityFrame.Models.Account", b =>
                {
            ...
            modelBuilder.Entity("EntityFrame.Models.Bank", b =>
                {
            ...
            modelBuilder.Entity("EntityFrame.Models.Client", b =>
                {
            ...
            modelBuilder.Entity("EntityFrame.Models.Transfer", b =>
                {
            ...
            modelBuilder.Entity("EntityFrame.Models.Account", b =>
                {
                    b.HasOne("EntityFrame.Models.Client", "cedula")
                        .WithMany("cedula_ac")
                        .HasForeignKey("cedula_cliente")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EntityFrame.Models.Bank", "codigo_banco")
            ...
            modelBuilder.Entity("EntityFrame.Models.Transfer", b =>
                {
                    b.HasOne("EntityFrame.Models.Bank", "codigo_banco_destino_bk")
                        .WithMany("codigo_banco_destino")
                        .HasForeignKey("cod_banco_destino")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EntityFrame.Models.Bank", "codigo_banco_origen_bk")
                        .WithMany("codigo_banco_origen")
                        .HasForeignKey("cod_banco_origen")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EntityFrame.Models.Account", "num_cta_origen")
                        .WithMany("numero_cta_origen")
                        .HasForeignKey("num_cta")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EntityFrame.Models.Account", "numero_cta_destino_ac")
